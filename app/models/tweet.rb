class Tweet < ApplicationRecord
  ...
  validates :content, length: { maximum: 256, too_long: 'of your tweet is too long. You Can\'t tweet more than %{count} characters.' }
  validates :content, presence: { message: 'of your tweet is empty. You haven\'t typed anything yet.' }, unless: :retweet_from_tweet_id?
  ...
  scope :root_tweets, -> { where( reply_to_tweet_id: nil ) }
